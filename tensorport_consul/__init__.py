...
from tensorport_consul.api import put_kv, get_kv, get_kv_cas, get_kv_meta, delete_kv, put_kv_txn
from tensorport_consul.serializer import map_dictionary, dictionary_map
from tensorport_consul.settings import DEFAULT_ENDPOINT, DEFAULT_REQUEST_TIMEOUT
...
class Connection(object):
    ...
    def __init__(self, endpoint=None, timeout=None, auth=None):
    ...
    def get(self, k=None, recurse=False):
        """
        Get a key or all keys if recursive is specified
        :param str k: key to get
        :param bool recurse: return nested entries
        :return dict mapping: retrieved key/value mapping
        """
    ...
    def get_value(self, k=None, recurse=False):
        """
